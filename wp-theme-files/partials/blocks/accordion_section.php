    ...
    <?php $t = 0; while(have_rows('accordion_section')): the_row(); ?>
      <div class="card">
        <div class="card-header" id="accordion-section-<?php echo $t; ?>-title">
          <h4>
            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#accordion-section-<?php echo $t; ?>-content" aria-expanded="false" aria-controls="accordion-section-<?php echo $t; ?>-content">
